...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <h1><i class="fa-solid fa-building"></i><input type="text" name="name" id="insertedName" placeholder="Company Name"></h1>
            <h5>Reg: <input type="text" name="name" id="insertedRegistryCode" placeholder="Company Registry Code"></h5>
            <input type="checkbox" id="generateNumber" name="generateNumber" />
            <label for="generateNumber">Generate Company number Automatically</label>
            <h5 id="company_number_holder">Company Number: <input type="text" name="company_number" id="company_number" placeholder="Company Number"></h5>
        </div>
    </div>
    ...
    <div class="row">
            ...
            <div class="panel panel-default panel-details">
                ...
                <div class="panel-body">
                    <table class="table">
                        <tbody>
                        <tr>
                            <td style="width:50%"><strong>Reg country:</strong></td>
                            <td>
                                <select id="insertedRegistrationCountry">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="insertedRegistrationDate" placeholder="Registration date"></td>
                        </tr>
                        <tr>
                            <td style="width:50%"><strong>VAT No:</strong></td>
                            <td><input type="text" id="insertedVat" placeholder="VAT No"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="insertedAddressStreet" placeholder="Street Address"><br><br>
                                <input type="text" id="insertedAddressCity" placeholder="City"><br><br>
                                <input type="text" id="insertedAddressZip" placeholder="ZIP"><br><br>
        ...
        <div class="col">
            <div class="panel panel-default panel-notes">
                ...
                <div class="panel-body">
                    <textarea cols="60" rows="5" id="insertedNotes" placeholder="Company Notes"></textarea>
                </div>
            </div>
        </div>
    </div>

    <form id="addNewCompany" action="{{ route('companies.store') }}" method="POST">
        @csrf
        <input type="hidden" name="name" id="name">
        <input type="hidden" name="registry_code" id="registry_code">
        ...
        <input type="hidden" name="address_zip" id="address_zip">
        <input type="hidden" name="address_dropdown" id="address_dropdown">
        <input type="hidden" name="notes" id="notes">
        <input type="hidden" name="number" id="number">
    </form>

    <button type="button" class="btn saveNewCompany" style="margin-top: 50px;">
        <i class="fa-solid fa-check"></i>Add
    </button>

    <script type="text/javascript">
        (function() {
            function initCompanyCreate() {
                // Check if jQuery is available (from bootstrap.js in app.js)
            ...
            if (document.readyState === 'complete') {
                ...
                window.addEventListener('load', initCompanyCreate);
            }
        })();
    </script>
@endsection
