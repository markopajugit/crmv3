...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <h1><i class="fa-solid fa-user"></i><input type="text" id="insertedName" placeholder="Person Name"></h1>
            <h5>Date of Birth: <input type="text" id="insertedDateOfBirth" placeholder="Date of Birth"></h5>
        </div>
    </div>
    ...
    <div class="row">
                ...
                <div class="panel-body">
                    <table class="table">
                        <tbody><tr>
                            ...
                            <td><input type="text" id="insertedIdCode" placeholder="ID code"></td>
                        </tr>
                        <tr>
                            <td style="width:50%"><strong>ID Code Country:</strong></td>
                            <td><select id="insertedCountry">
                        ...
                        <tr>
                            <td style="width:50%"><strong>Estonian ID Code:</strong></td>
                            <td><input type="text" id="insertedEstIdCode" placeholder="ID code"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="insertedPhone" placeholder="Phone No"></td>
                        </tr>
                        <tr>
                            <td style="width:50%"><strong>KYC (TEST) (Not Working)</strong></td>
                            <td><input type="checkbox" id="kyc" name="kyc" value="yes">
                                <label for="kyc">Enable</label><br></td>
                        </tr>
                        </tbody></table>
                </div>
            </div>
        ...
        <!--<div class="col">
            <div class="panel panel-default panel-notes">
                ...
                <div class="panel-body">
                    <textarea cols="60" rows="5" id="insertedNotes" placeholder="Person Notes"></textarea>
                </div>
            </div>
        </div>-->
    </div>
    ...
    <div class="row">
        <div class="col">
            <div id="kycresult">KYC test</div>
        </div>
    </div>

    <form id="addNewPerson" action="{{ route('persons.store') }}" method="POST">
        @csrf
        <input type="hidden" name="name" id="name">
        <input type="hidden" name="date_of_birth" id="date_of_birth">
        <input type="hidden" name="country" id="country">
        <input type="hidden" name="id_code" id="id_code">
        <input type="hidden" name="id_code_est" id="id_code_est">
    ...
    <button type="button" class="btn saveNewPerson" style="margin-top: 50px;">
