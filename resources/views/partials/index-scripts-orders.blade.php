@php
    ...
    // $tableBodyId - ID for table body (e.g., "ordersTableBody")
    // $paginationId - ID for pagination container (e.g., "ordersPagination")
    // $indexRoute - Route name for index action (e.g., "orders.index")
    // $countId - ID for count element (e.g., "ordersCount")
    // $singular - Singular form of entity (e.g., "order")
    // $plural - Plural form of entity (e.g., "orders")
@endphp
...
$(document).ready(function() {
    ...
    const $filterResponsible = $('#filterResponsible');
    const $filterStatus = $('#filterStatus');
    const $filterPaymentStatus = $('#filterPaymentStatus');
    ...
    $filterResponsible.on('change', function() {
